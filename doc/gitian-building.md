...
*Setup instructions for a gitian build of Barnacoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Barnacoin
...
- [Building Barnacoin](#building-barnacoin)
...
Clone the git repositories for barnacoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/barnacoin/barnacoin
```
...
In [doc/release-process.md](release-process.md) in the barnacoin repository under 'Fetch and build inputs'.
...
To build Barnacoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the barnacoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/barnacoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/barnacoin/barnacoin
...
For example:
```bash
URL=https://github.com/laanwj/barnacoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit barnacoin=${COMMIT} --url barnacoin=${URL} ../barnacoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit barnacoin=${COMMIT} --url barnacoin=${URL} ../barnacoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/barnacoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/barnacoin-build.assert
```
...
[barnacoin/gitian.sigs](https://github.com/barnacoin/gitian.sigs/) repository, or
