Barnacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/barnacoin/files/Barnacoin/barnacoin-0.5.4/
...
http://gitorious.org/barnacoin/barnacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Barnacoin-Qt notifications under Growl 1.3.
Increase required age of Barnacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBarnacoin properly when installing Barnacoin-Qt over it. (Windows)
