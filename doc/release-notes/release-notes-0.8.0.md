Barnacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/barnacoin/files/Barnacoin/barnacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Barnacoin
...
New/changed settings (command-line or barnacoin.conf file)
--------------------------------------------------------
