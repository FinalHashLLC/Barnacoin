The following is a list of assets used in the barnacoin source and their proper attribution.
...
* License: MIT
* Site: [https://barnacointalk.org/index.php?topic=15276.0](https://barnacointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original barnacoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/barnacoin.icns, src/qt/res/src/barnacoin.svg,
	src/qt/res/src/barnacoin.ico, src/qt/res/src/barnacoin.png,
	src/qt/res/src/barnacoin_testnet.png, docs/barnacoin_logo_doxygen.png,
