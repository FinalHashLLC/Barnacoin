...
B4ARGS="-datadir=$D4"
$BARNACOIND $BARNACOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$BARNACOIND $BARNACOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $BARNACOIND $BARNACOINDARGS $B1ARGS &
  B1PID=$!
  $BARNACOIND $BARNACOINDARGS $B2ARGS &
  B2PID=$!
  $BARNACOIND $BARNACOINDARGS $B3ARGS &
  B3PID=$!
}
