// Copyright (c) 2011-2014 The Barnacoin Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CBarnacoinSecret::SetString tests isValid, whereas CBarnacoinAddress does not!
