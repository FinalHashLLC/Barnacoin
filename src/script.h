...
#ifndef H_BARNACOIN_SCRIPT
#define H_BARNACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBarnacoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Barnacoin always counted CHECKMULTISIGs
