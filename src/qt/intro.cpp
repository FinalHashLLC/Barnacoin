...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/barnacoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Barnacoin"),
     ...
     * override -datadir in the barnacoin.conf file in the default data directory
     * (to be consistent with barnacoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
