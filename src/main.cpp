...
#if defined(NDEBUG)
# error "Barnacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Barnacoin Signed Message:\n";
...
static const int64_t nTargetSpacing = 45;
...
void ThreadScriptCheck() {
    RenameThread("barnacoin-scriptch");
